...
## Dot Command  
Whatever last atomic command you performed, can be reiterated in 


## Find and replace
The main way to search is ```/```
...
ctags -R .
```
at the root directory. Once done generating, you can move around the functions using ```Ctrl + ]```.   
